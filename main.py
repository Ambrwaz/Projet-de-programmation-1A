...
import Enigma_Cipher as enigma
...
def unit_test_substitution():
    ...
    if decrypted_message_without_key != s.clear(Message_test) and differences > 5:
        ...
        print("Cryptage par substitution : RAS.\n")
    
unit_test_caesar()
unit_test_vigenere()
unit_test_substitution()
#Si le test unitaire de la méthode par la substitution tourne en boucle, c'est que l'algorithme est bloqué et il faut le relancer, le déchiffrage n'est que partiel mais on a déjà une bonne idée du texte final
#Lancer le test unitaire d'enigma pour voir si ça marche
enigma.test_Enigma_Cipher()
